...
rem set XMLPath=livre_sans_ns.xml
rem set XMLPath=livre_sans_ns_invalid.xml
rem set XSDPath=livre_sans_ns.xsd

rem set XMLPath=biblio_sans_ns.xml
set XMLPath=biblio_sans_ns_invalid.xml
set XSDPath=biblio_sans_ns.xsd
