...
rem set XMLPath=livre.xml
rem set XMLPath=livre_invalid.xml
rem set XSDPath=livre.xsd

rem set XMLPath=biblio.xml
set XMLPath=biblio_explicit_ns.xml
rem set XMLPath=biblio_invalid.xml
set XSDPath=biblio.xsd
